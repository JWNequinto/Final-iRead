    ...
    <section>
        ...
        <div class="content">
            <div class="textBox">
                ...
                <a href="hpabout.html">Learn More</a>
            </div>
            <div>
            <div class="imgBox">
    ...
    <section class="book4">
		<div class="main">
			...
			<div class="book1-text">
				...
				<a href="hpbook1.php"><button type="button">READ NOW</button></a>
			</div>
		</div>
	</section>
		...
		<div class="main">
			...
			<div class="book2-text">
				...
				<p>A clean teen romance comedy about figuring out where you belong when all the constants in your life begin to change.
                    ...
                    <a href="hpbook2.php"><button type="button">READ NOW</button></a>
			</div>
		</div>
	</section>
    ...
    <section class="book3">
		<div class="main">
			...
			<div class="book3-text">
				...
				<a href="hpbook3.php"><button type="button">READ NOW</button></a>
			</div>
		</div>
	</section>
