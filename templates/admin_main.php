    ...
    <section class="book4">
		<div class="main">
			...
			<div class="book1-text">
				...
				<a href="adminbook1.php"><button type="button">READ NOW</button></a>
			</div>
		</div>
	</section>
		...
		<div class="main">
			...
			<div class="book2-text">
				...
				<p>A clean teen romance comedy about figuring out where you belong when all the constants in your life begin to change.
                    ...
                    <a href="adminbook2.php"><button type="button">READ NOW</button></a>
			</div>
		</div>
	</section>
    ...
    <section class="book3">
		<div class="main">
			...
			<div class="book3-text">
				...
				<a href="adminbook3.php"><button type="button">READ NOW</button></a>
			</div>
		</div>
	</section>
