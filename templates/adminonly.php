...
<body>
        <nav>
        <a href="admin_main.php"><img src="../images/logo.png" class="logo"></a>
            <ul>
            ...
            <div class="divsearch">
                <table>
                    <tr width="1500px" height="80px">                        
                        <form action="adminonly.php" method="post">                                                              
                            ...
                            <td width="300px" height="80px">
                                <select name="status">
                                    ...
                                    <option value="Approved">Approved Books</option>
                                    <option value="Denied">Denied Books</option>
            ...
            <div class="lob">
                ...
                <?php 
                    if (isset($_POST['searchbutton']) && isset($_POST['stitle'])) {
                        $stitle = $_POST['stitle'];
                        $sql = "SELECT img_dir,title,story FROM books WHERE title like '%$stitle%' ORDER BY id ASC";
                        ...
                        if (mysqli_num_rows($res) > 0) {
                            ...
                            <div class="alb">
                                    ...
                                    <form action="checkbookphp.php" method="POST" enctype="multipart/form-data">
                                        <input class="pttle" name="btitle" value="<?=$row['title']?>">
                                        <button class="rbtn" name="readnow">Check Book</button>
                                    </form>
                            </div>                             
                <?php 
                            }
                    ...
                    }elseif (isset($_POST['gobutton']) && isset($_POST['stitle']) && isset($_POST['status'])) {
                        $stitle = $_POST['stitle'];
                        $status = $_POST['status'];
                        $sql = "SELECT img_dir,title,story FROM books WHERE title like'%$stitle%' and status like '%$status%' ORDER BY id ASC";
                        $res = mysqli_query($conn,  $sql);
                ...
                <?php 
                        ...
                        $sql = "SELECT img_dir,title,story FROM books ORDER BY id ASC";
                        $res = mysqli_query($conn,  $sql);
